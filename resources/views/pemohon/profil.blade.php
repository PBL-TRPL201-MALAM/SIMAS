...
@include('template.sidebar.pemohon', ['activePage' => 'profil'])
    <div class="flex flex-col flex-1 min-w-0 overflow-hidden">
      <header class="flex items-center justify-between h-16 px-6 bg-white border-b border-slate-100/80 shrink-0">
        ...
        <div>
          ...
          <p class="text-[11px] text-slate-400 font-light">Informasi akun pemohon.</p>
        </div>
      ...
      <main class="flex-1 overflow-y-auto p-6">
        <div id="page-profil" class="page-content max-w-3xl space-y-6">
          ...
          <div class="rounded-2xl bg-white border border-slate-100 p-6">
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p class="text-sm text-slate-500">{{ $user->email }} &middot; Pemohon</p>
              </div>
            </div>
            ...
            <form action="{{ route('pemohon.profil.update') }}" method="POST" class="space-y-5">
              @csrf
              @method('PUT')
          ...
          <div class="rounded-2xl bg-white border border-slate-100 p-6">
            ...
            <form action="{{ route('pemohon.profil.password') }}" method="POST" class="space-y-4">
              @csrf
              @method('PUT')
              <div>
